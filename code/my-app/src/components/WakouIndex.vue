    ...
    <body>
        ...
        <div class="header">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <h1>みんなをつなぐ <br> 和光のイベントカレンダー</h1>
                        <p>和光イベントカレンダーは<br>・イベントを見逃さない、集まりやすい<br>・イベント、和光を育てる<br>・イベント管理にぴったり
                            <br>な和光市専用のイベント管理プラットフォームです
                        </p>
                        <a href="" class="btn">Explore Now &#8594;</a>
                    </div>
                    <div class="col-2">
                        <img src="https://www.city.wako.lg.jp/var/rev0/0115/0447/wakotti121_p.png">
                    </div>
        ...
        <div class="categories">
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-3" v-for="(item, key) in store_top3" :key="key">
        ...
        <div class="small-container">
            ...
            <div class="row">
                <div class="col-4" v-for="(item, key) in store_after3" :key="key">
                    <a v-bind:href="`product_details.html?id=${item.id}`"><img v-bind:src="`${item.image}`"></a>
                    <h4>{{ item.title }}</h4>
                    <div class="rating">
